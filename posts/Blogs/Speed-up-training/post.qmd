...
![The representation of Float32](assets/float32.png){#fig-float32}

![The representation of Float16](assets/float16.png){#fig-float16}  

![The representation of BFloat16](assets/bfloat16.png){#fig-bfloat16}
...
![Broadcast](assets/broadcast.png){#fig-broadcast}

![Scatter](assets/scatter.png){#fig-scatter}

![Gather](assets/gather.png){#fig-gather}

![Reduce](assets/reduce.png){#fig-reduce}

![All-gather](assets/all-gather.png){#fig-all-gather}

![Reduce-scatter](assets/reduce-scatter.png){#fig-reduce-scatter}

![All-reduce](assets/all-reduce.png){#fig-all-reduce}
